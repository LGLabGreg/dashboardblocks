...
On every pull request, every block is installed with the shadcn CLI into a new project for each component library, each with a different style and icon library. The projects must type-check and build.
